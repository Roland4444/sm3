...
public class EBS_ESIA_F extends JAktor {
    Gost3411Hash hash = new Gost3411Hash();
    private DependencyContainer deps_c;

    public EBS_ESIA_F(DependencyContainer deps) {
        this.deps_c = deps;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            EBS_ESIA_F ebss = new EBS_ESIA_F(deps);
            ...
            while (true) {
                ...
                try {
                    System.out.println("\n\n\nGET RESPONCES (Intelligent)==>");
                    sch.processor.getResponsesIntelligent();
